...
function Index() {
  ...
  return (
    ...
    <section id='projects' style={{ backgroundColor: "#dde6ed"}}>
      <div className="container">
        <div className="row">
          ...
          <source src="./public/video/Pix & Words.mp4" type="video/mp4" />          </video>
          </div>
    ...
    <section>
      ...
      <a href="./public/pdf/suhaib_akther_s_resume.pdf" download><button className='btn btn-outline-primary mb-5' style={{fontFamily: "'Poppins', sans-serif", letterSpacing: "0.1em"}}>Download Resume</button>
      </a>
      </div>
    </section>
    </section>
